...
import supplierProductsViewDelete from '../controllers/supplierProductsViewDelete'
...
HomeRoutes.post('/supplierProductsViewDelete', supplierProductsViewDelete.supplierProductsViewDelete)
